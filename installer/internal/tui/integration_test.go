...
func TestInstallStepsSetup(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			existConfigs:  []string{},
			expectedSteps: []string{"clone", "shell", "postingconfig", "setshell", "cleanup"},
		},
		{
			...
			expectedSteps: []string{"backup", "clone", "terminal", "font", "shell", "wm", "nvim", "postingconfig", "setshell", "cleanup"},
		},
		{
			...
			existConfigs:  []string{},
			expectedSteps: []string{"deps", "clone", "homebrew", "terminal", "font", "shell", "wm", "nvim", "postingconfig", "setshell", "cleanup"},
		},
	}
